...
if user_input == "1":
	...
	if user_input == "1":
		...
		print("You wait another 15 minutes. You are late to work. As the B train you were awaiting approaches, you become excited. However, in that moment your boss calls and tells you that you are fired because you are late. What else could you expect from the girl late on her first day?")
		print("The end! ")
